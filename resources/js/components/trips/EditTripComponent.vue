			...
			<div class="flex-grow pr-8 w-2/3 relative">
				...
				<div class="w-full mt-4">
					...
					<div>
						...
						<textarea v-model="trip.description" class="w-full block mt-2 px-4 py-3 bg-gray-100 shadow rounded focus:outline-none focus:shadow-md" name="" id="" cols="30" rows="10"></textarea>
						<div>
							<span></span>
							<span></span>
						</div>
